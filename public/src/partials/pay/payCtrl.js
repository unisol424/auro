    ...
    .controller(
        ...
        function (
            ...
            $scope.currencyChange = function () {
                currency = $scope.selectedCurrency.currency === 'ORO' ? null : $scope.selectedCurrency.currency;
                precision = $scope.selectedCurrency.currency === 'ORO' ? 6 : $scope.selectedCurrency.precision;
            };
            ...
            $scope.sentMsg = function () {
                ...
                transaction = AcchainJS.transaction.createTransaction(
                    String($scope.fromto),
                    amount.toString(),
                    currency,
                    $scope.remark,

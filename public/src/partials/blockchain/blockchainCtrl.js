                ...
                apiService
                    ...
                    .success(function (res) {
                        if (res.success) {
                            ...
                            res.transaction.recipientId =
                                res.transaction.recipientId === '' ? 'System' : res.transaction.recipientId;
                            res.transaction.currency =
                                res.transaction.currency === '' ? 'ORO' : res.transaction.currency;
                            ...
                            if (res.count != 0) {
                                ...
                                for (var i = 0; i < res.balances.length; i++) {
                                    res.balances[i].balance =
                                        res.balances[i].balance / Math.pow(10, res.balances[i].precision);
                                }
                    ...
                    function (response) {
                        if (response.success) {
                            ...
                            for (var i = 0; i < items.length; i++) {
                                ...
                                items[i].currency = items[i].currency === '' ? 'ORO' : items[i].currency;
